...
export function buildDigestMessage(digest: WeeklyDigest, baseUrl: string): string {
  const lines: string[] = [
...
export async function sendDigestToTelegram(env: Env, digest: WeeklyDigest): Promise<void> {
