...
checkQr.post('/api/check-qr', async (c) => {
    ...
    const urlAnalysis = await analyzeUrl(rawData, safeBrowsingEnabled ? c.env.GOOGLE_SAFE_BROWSING_KEY : undefined, c.env.VIRUSTOTAL_API_KEY, c.env.CACHE, c.env.URLHAUS_AUTH_KEY);
    return c.json({
        request_id: rid,
