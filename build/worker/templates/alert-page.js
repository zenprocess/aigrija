...
function buildJsonLd(campaign, baseUrl) {
...
export function renderAlertPage(campaign, baseUrl, checksMatched, reportCount, lastReport) {
...
export function renderAlertsIndex(campaigns, baseUrl) {
