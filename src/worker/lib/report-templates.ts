...
export function templatePlangere(p: ReportParams): string {
...
export function templatePetitiePolitie(p: ReportParams): string {
...
export function templateRaportDNSC(p: ReportParams): string {
...
export function templateSesizareBanca(p: ReportParams): string {
...
export type ReportType = 'plangere-penala' | 'petitie-politie' | 'raport-dnsc' | 'sesizare-banca';

export const REPORT_INSTRUCTIONS: Record<ReportType, string> = {
...
export function generateReport(type: ReportType, params: ReportParams): { template: string; instructions: string } {
  let template: string;
  switch (type) {
