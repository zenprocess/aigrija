 ...
 */
export async function handleReportSignalQueue(batch, env) {
        ...
        try {
            ...
            if (agg.count >= EMERGING_CAMPAIGN_THRESHOLD) {
                ...
                if (!existing) {
                    ...
                    const campaign = JSON.parse(existing);
